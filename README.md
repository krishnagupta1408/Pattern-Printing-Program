...
Question 1: WAP in C++ to print the following pattern.
...
Question 2: WAP to find all substrings of a given string that contains all characters of other string.
 Example:
